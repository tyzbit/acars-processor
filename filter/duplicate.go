...
var (
	...
	RecentACARSMessages []acarshub.ACARSMessage
	RecentVDLM2Messages []acarshub.VDLM2Message
)
...
func FilterDuplicateACARS(m acarshub.ACARSMessage) bool {
...
// using Hamming distance. If similarity above configured setting,
// filter out the message.
func FilterDuplicateVDLM2(m acarshub.VDLM2Message) bool {
	// Don't filter if 0 similarity or unset
