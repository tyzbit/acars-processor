...
// Filterers filter messages by evaluating existing fields and any new fields
// they are compatible with (like "aircraft_geolocation") added by Annotators.
// If the message does not get filtered, it will eventually be sent to
// any configured Receivers
...
type AnnotateStep struct {
	...
	// Remove all but these fields for this annotator step. You can have an annotation step that only selects fields.
	SelectedFields []string
}
