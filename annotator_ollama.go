...
type OllamaAnnotatorResponse struct {
	Question        bool   `json:"question" ap:"LLMQuestion"`
	ModelFeedback   string `json:"model_feedback" ap:"LLMText"`
	ProcessedText   string `json:"processed_text" ap:"LLMStringResult"`
	ProcessedNumber int    `json:"processed_number" ap:"LLMNumberResult"`
}
