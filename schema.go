...
func MarshalYAMLWithComments(v interface{}) ([]byte, error) {
	comments, err := extractAllCodeComments()
	if err != nil {
		return nil, err
	}
...
// extractAllCodeComments parses Go source files to collect struct field doc comments.
func extractAllCodeComments() (commentMap, error) {
